...
class GithubScmSpec extends JenkinsPipelineSpecification {
    ...
    def setup() {
        ...
        groovyScript.getBinding().setVariable("MAVEN_SETTINGS_XML", 'path/to/settings.xml')
    ...
    def "[githubscm.groovy] tagLocalAndRemoteRepository all params and tag exists"() {
        ...
        2 * getPipelineMock("sh")('git config user.email user@jenkins.kie.apache.org')
...
"""
    ...
    def "[githubscm.groovy] prepareCommitStatusInformation default"() {
        ...
        then:
        1 * getPipelineMock("dir")('githubscm-prepare-commit-REPO-NAME', _)
